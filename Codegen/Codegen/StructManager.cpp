...
Result<unsigned, std::shared_ptr<LangError>> StructManager::get_field_index(llvm::StructType* type, const std::string& field_name)
{
    ...
    return std::make_shared<LangError>("Cannot get field '" + field_name + "' from struct");
}
