...
namespace GeneratorHelper
{
    ...
    Result<binary_operation_fn, LangError> get_binary_operation_fn(Type* type, const std::string& operation)
    {
    ...
    Result<Type*, LangError> get_type_from_string(const std::string& type)
    {
        ...
        return LangError(InvalidSymbolError(type));
    }
